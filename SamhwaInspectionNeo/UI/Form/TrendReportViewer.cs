...
namespace SamhwaInspectionNeo.UI.Form
{
    public partial class TrendReportViewer : XtraForm
    {
        ...
        private void Init()
        {
            ...
            {
                if (정보.검사항목 >= 검사항목.Slot1_1 && 정보.검사항목 <= 검사항목.Slot1_5)
                {
                    Slot1치수.Add(정보.검사항목);
                    cSlot1.Y축설정(정보.최소값, 정보.최대값);
                }
                else if (정보.검사항목 >= 검사항목.Slot2_1 && 정보.검사항목 <= 검사항목.Slot2_5)
                {
                    Slot2치수.Add(정보.검사항목);
                    cSlot2.Y축설정(정보.최소값, 정보.최대값);
                }

                else if (정보.검사항목 >= 검사항목.Slot3_1 && 정보.검사항목 <= 검사항목.Slot3_5) 
                { 
                    Slot3치수.Add(정보.검사항목);
                    cSlot3.Y축설정(정보.최소값, 정보.최대값);
                }
                else if (정보.검사항목 >= 검사항목.Slot4_1 && 정보.검사항목 <= 검사항목.Slot4_5)
                { 
                    Slot4치수.Add(정보.검사항목);
