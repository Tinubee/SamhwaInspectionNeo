...
namespace SamhwaInspectionNeo.UI.Form
{
    public partial class Login : XtraForm
    {
        ...
        public Login()
        {
            ...
            this.e영어.Text = MvUtils.Utils.GetDescription(Language.EN);
            this.e한글.Text = MvUtils.Utils.GetDescription(Language.KO);
        ...
        {
            string 사용자명 = MvUtils.Utils.StrValue(this.e사용자명.Text);
            string 비밀번호 = MvUtils.Utils.StrValue(this.e비밀번호.Text);
            ...
            else
            {
                ...
                else
                {
                    ...
                    MvUtils.Utils.WarningMsg(번역.인증오류, Localization.경고.GetString());
                    this.e비밀번호.Focus();
                }
            }
        }
